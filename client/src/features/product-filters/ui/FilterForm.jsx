...
import { fetchTypes, fetchFactories, fetchFilteredProducts, fetchSizeRanges, fetchPriceRange } from '../api/filterApi';
...
const FilterForm = ({ onFilterChange }) => {
    ...
    useEffect(() => {
        ...
        loadInitialData();
    }, [location.search, isInitialLoad, onFilterChange]);
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs={12} className="mt-3">
                                    <Slider
                                        ...
                                        allowCross={false}
                                        trackStyle={[{ backgroundColor: '$main_color' }]}
                                        handleStyle={[
                                            { backgroundColor: '#fff', borderColor: '$main_color' },
                                            { backgroundColor: '#fff', borderColor: '$main_color' }
                                        ]}
                                    />
                                </Col>
